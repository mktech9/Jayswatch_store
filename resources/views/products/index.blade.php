                                    ...
                                    <div class="row g-3">
                                        ...
                                        @if (all_admin())
                                            <div class="col-md-3">
                                                ...
                                                <select id="filter_stock" class="form-select">
                                        ...
                                        @if (loggedUserName() === Session::get('super_admin_username'))
                                            <div
                                                class="col-md-3 d-flex justify-content-end align-items-end gap-2 ms-auto">
                                                <button type="button" class="btn btn-warning text-dark"
                                                    data-bs-toggle="modal" data-bs-target="#bulkExcelModal">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="listUsers" role="tabpanel">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered text-nowrap w-100" id="productTable">
                                            <thead>
                                                <tr>
                                                    <th>No.</th>
                                                    <th>Action</th>
                                ...
                                <div class="tab-pane fade" id="addUsers" role="tabpanel">
                                    <form id="productForm" class="needs-validation" novalidate>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <label for="dialDiameter" class="form-label">Dial Diameter
                                                        (mm)</label>
                                                    <input type="text" class="form-control" id="dialDiameter"
                                                        name="dial_diameter" placeholder="Enter diameter in mm">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    <div class="form-check mt-4">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="show_yearcard" name="show_yearcard" value="1">
                                                        <label class="form-check-label" for="show_yearcard">Show Year
                                                            Card</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                        ...
                                        <div class="step-content" id="step5" style="display: none;">
                                            ...
                                            <div class="row">
                                                <!--<div class="col-md-4 mb-3">-->
                                                <!--     <label for="displayLocation" class="form-label">-->
                                                <!--         Display Location <span class="text-danger">*</span>-->
                                                <!--     </label>-->

                                                <!--     <select class="form-select select2" id="displayLocation"-->
                                                <!--         name="display_location_id[]" multiple="multiple" required>-->

                                                <!--         @foreach ($store_location->whereIn('location_id', ['HO', 'TCL']) as $location)
-->
                                                <!--             <option value="{{ $location->bl_id }}">-->
...
@endforeach-->
                                                ...
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <select class="form-select select2" id="displayLocation"
                                                        ...
                                                        <option value="7">Tata Cliq - TCL</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2 mb-3">
                                                    <div class="form-check mt-4">
                                                        <input type="checkbox" class="form-check-input"
                                                            id="inStock" name="in_stock" value="1">
                                                        <label class="form-check-label" for="inStock">In Stock
                                                        </label>
                                                    </div>
                                                </div>
            ...
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="stock_pro_id">

                        <!-- Product Info -->
                        <div class="row mb-3">
                            <div class="col-md-8">
                                <label class="form-label">Product Name</label>
                                <input type="text" class="form-control" id="stock_pro_name" readonly>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="stockHistoryTable" width="100%">
                                <thead class="table-light">
                                    <tr>
                                        <th>#</th>
                                        <th>Location</th>
        ...
        <div class="modal fade" id="duplicateModal" tabindex="-1">
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content shadow border-0">
                    ...
                    <div class="modal-header bg-light border-0 pb-0 pt-4 px-4">
                        <div>
                            ...
                            <p class="text-muted mt-1 mb-0 small">
                                Create a new product based on existing configuration
                            </p>
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    ...
                    <div class="px-4 pt-3">
                        <div class="alert alert-primary bg-opacity-10 border border-primary bg-light p-3 rounded-3">
                            <div class="d-flex align-items-center gap-3 flex-wrap">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex align-items-center gap-3 mt-1">
                                        <h6 class="mb-0 fw-bold" id="referenceProductName">—</h6>
                                        <span class="badge bg-secondary bg-opacity-10 text-dark fw-normal d-none"
                                            id="referenceProductId">ID: —</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <form id="duplicateProductForm" novalidate>
                        @csrf
                        ...
                        <div class="modal-body px-4 py-3">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Product Model</label>
                                        <input type="text" id="pro_modelModal" name="pro_model"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="pro_ref_numModal" name="pro_ref_num"
                                            class="form-control form-control-lg bg-light border-0" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="collectionModal" name="collection"
                                            class="form-control form-control-lg bg-light border-0" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="brandModal" name="brand"
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">Year of Card</label>
                                        <input type="text" id="yearOfCardModal" name="year_of_card"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="skuModal" name="sku"
                                            class="form-control form-control-lg bg-light border-0" required>
                                        <div class="invalid-feedback">SKU is required</div>
                                    </div>

                                    <div class="alert alert-info mt-2 p-2"
                                        style="background: #eef2ff; border: none;">
                                        <small>All fields can be modified before saving.</small>
                                    </div>
                                ...
                                <input type="hidden" id="productidModal" name="product_id">
        ...
        <div class="modal fade" id="bulkExcelModal" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Bulk Update By Excel</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>

                    <div class="modal-body">

                        <input type="file" id="bulk_excel_file" class="form-control" accept=".xlsx,.xls">

                        <small class="text-muted">
                            Upload edited exported excel file. SKU required.
                        </small>

                        <hr>

                        <div id="bulkUpdateResult"></div>

                    </div>

                    <div class="modal-footer">
                        <button type="button" id="uploadBulkExcel" class="btn btn-primary">
                            Upload & Update
                        </button>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#inStock, #outOfStock').on('change', function() {

                if ($(this).is(':checked')) {
                    $('#inStock, #outOfStock').not(this).prop('checked', false);
                }
            ...
            function calculateMargin() {
                ...
                if (purchasePrice > 0) {
                    let marginPercent = ((sellingPrice - purchasePrice) / purchasePrice) * 100;

                    // ✅ Prevent negative margin
                    marginPercent = Math.max(0, marginPercent);

                    $("#margin").val(marginPercent.toFixed(2));
                } else {
                    $("#margin").val(0);
                }
            }
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#brandModal').select2({
                dropdownParent: $('#duplicateModal'), // 👈 IMPORTANT
            ...
            function resetFormFully() {
                ...
                skuManuallySet = false; // ✅ unlock SKU auto-gen for fresh add
                ...
                $('#edit_pro_id').remove();
                $('#saveProductBtn').text('Submit Product');
            ...
            let yearCardPicker = flatpickr("#yearOfCardModal", {
                dateFormat: "Y-m-d",
                altInput: true,
                altFormat: "d-m-Y",
                maxDate: "today",
            ...
            $('#productForm').on('submit', function(e) {
                ...
                fd.append('in_stock', $('#inStock').is(':checked') ? '1' : '0');
                ...
                fd.append('show_yearcard', $('#show_yearcard').is(':checked') ? '1' : '0');
            ...
            // ─── DataTable + View Modal + Edit Handler ─────────────────────────────────
        ...
        `;
            ...
            $("#scrollRight").on("click", function() {
                $(".dataTables_scrollBody").animate({
                    scrollLeft: "+=200" // move right 200px
                }, 300);
            });

            $("#scrollLeft").on("click", function() {
                $(".dataTables_scrollBody").animate({
                    scrollLeft: "-=200" // move left 200px
                }, 300);
            });
 ...
 <div class="col-md-3">
    ...
    `;
        ...
        `;
                            ...
                            $('#productType')
                                ...
                                .trigger('change');
                            $('#gender').val(d.pro_gender ? d.pro_gender.split('/') : [])
                                .trigger('change');
                            ...
                            $('#category').val(d.category ? d.category.split('/') : []).trigger(
                                'change');
                            ...
                            $('#inStock').prop('checked', d.out_stock == 0);
                            $('#notforselling').prop('checked', d.not_for_selling == 1);
                            $('#show_yearcard').prop('checked', d.show_yearcard == 1);
            ...
            $('a[href="#addUsers"]').on('shown.bs.tab', function() {
                ...
                // ✅ Always reset the flag when tab is shown
                isEditing = false;
            });
            ...
            $(document).on('click', '.addStock', function() {
                ...
                $('#stock_pro_id').val(proId);
                $('#stock_pro_name').val(proName);

                $.ajax({
                    url: "{{ route('product.fetchStockLocations') }}",
                    type: "GET",
                    data: {
                        pro_id: proId
                    },
                    success: function(res) {
                        buildLocationTable(res.locations, res.physical_quantity);

                        // ✅ Load history
                        loadStockHistory(proId);
            ...
            $(document).on('click', '.add-stock-btn', function() {
                ...
                // Set only this row to 1
                row.find('.location-qty').val(1);
            });

            $(document).on('input', '.location-qty', function() {
                let enteredVal = parseInt($(this).val()) || 0;
                ...
                if (enteredVal === 1) {
                    $('.location-qty').not(this).val(0);
                }
            });


            function buildLocationTable(locations, physicalQty) {
                let html = '';
                ...
                locations.forEach(function(loc) {
                    ...
                    // ✅ Prefill ONLY physical location
                    if (loc.type === 'physical' && physicalQty > 0) {
                        qtyValue = 1;
                    }
            ...
            <tr>
                <td>
                    <b>${loc.name}-${loc.location_id}</b>
                    ${loc.type === 'physical'
                        ? '<span class="badge bg-primary ms-2">Physical</span>'
                        : '<span class="badge bg-secondary ms-2">Display</span>'}
                </td>
                ...
                <td>
                    <div class="d-flex gap-2">
                        <input type="text"
                            class="form-control location-note"
                            placeholder="Notes (optional)">

                        <button type="button"
                            class="btn btn-sm btn-outline-success add-stock-btn"
        ...
        `;
                ...
                $('#locationStockBody').html(html);
            }

            // Handle click on dynamically added plus buttons
            $(document).on('click', '.add-stock-btn', function() {

                let row = $(this).closest('tr');

                let locationId = row.find('.location-qty').data('location-id');
                let proId = $('#stock_pro_id').val();
                let note = row.find('.location-note').val();

                $.ajax({
                    url: "{{ route('product.addStock') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        pro_id: proId,
                    ...
                    success: function(res) {
                        ...
                        if (res.status === 'updated') {
                            ...
                            $.ajax({
                                ...
                                success: function(res) {
                                    buildLocationTable(res.locations, res
                                        .physical_quantity);
                                }
                            });

                            // (optional) update UI qty instantly
                            productTable.ajax.reload(null, false);
                            loadStockHistory(proId);
                            let qtyInput = row.find('.location-qty');
                            if (qtyInput.length) {
            ...
            function loadStockHistory(proId) {
                ...
                stockHistoryTable = $('#stockHistoryTable').DataTable({
                    ajax: {
                        url: "{{ route('product.fetchStockHistory') }}",
                        data: {
                            pro_id: proId
                        },
            ...
            $(document).on('click', '.duplicateProduct', function() {
                let id = $(this).data('id');

                // Loading state
                $('#pro_modelModal').val('Loading...').prop('disabled', true);
                $('#pro_ref_numModal').val('Loading...').prop('disabled', true);
                $('#brandModal').prop('disabled', true);
                $('#collectionModal').val('Loading...').prop('disabled', true);
                $('#skuModal').val('Loading...').prop('disabled', true);
                $('#referenceProductName').text('Fetching data...');
                $('#referenceProductId').text('ID: --');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#pro_modelModal').val(response.pro_model || '').prop('disabled',
                            false);
                        $('#pro_ref_numModal').val(response.pro_ref_num || '').prop('disabled',
                            false);
                        $('#collectionModal').val(response.collection || '').prop('disabled',
                            false);
                        $('#skuModal').val(response.sku || '').prop('disabled', false);

                        if (response.brand) {
                            $('#brandModal').val(response.brand).trigger('change');
                        } else {
                            $('#brandModal').val('').trigger('change');
                        }
                        $('#brandModal').prop('disabled', false);

                        $('#referenceProductName').text(response.pro_name || 'Unnamed Product');
                        $('#productidModal').val(response.pro_id || id);
                        yearCardPicker.setDate(response.year_of_card || '', true);

                        $('#referenceProductId').text('ID: ' + (response.pro_id || id));

                        if ($('#productnameModal').length) {
                            $('#productnameModal').val(response.pro_name || '');
                        }
                    ...
                    error: function(xhr, status, error) {
                        ...
                        // Reset fields
                        $('#pro_modelModal').val('Error loading data').prop('disabled', false);
                        $('#pro_ref_numModal').val('Please try again').prop('disabled', false);
                        $('#collectionModal').val('Error').prop('disabled', false);
                        $('#skuModal').val('Error').prop('disabled', false);
                        $('#brandModal').prop('disabled', false);
                        $('#referenceProductName').text('Failed to load');
                        $('#referenceProductId').text('ID: --');

                        // ✅ iziToast instead of alert & console
                        iziToast.error({
                            title: 'Error',
                            message: 'Unable to fetch product details. Please refresh and try again.',
                            position: 'topRight',
                            timeout: 3000
                        });
            ...
            $('#duplicateProductForm').on('submit', function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        iziToast.success({
                            title: 'Success',
                            message: res.message ?? 'Product duplicated successfully',
                            position: 'topRight',
                            timeout: 3000
                        });
                        productTable.ajax.reload(null, false);
                        $('#duplicateModal').modal('hide');
                        $('#duplicateProductForm')[0].reset();
    ...
    <script>
        let skuManuallySet = false;
        let skuPopulating = false; // ✅ true during edit field population, ignore triggers

        function generateSKURealtime() {
            if (skuManuallySet || skuPopulating) return;

            let skuField = document.getElementById("sku");

            let brandText = document.getElementById("brand").selectedOptions[0]?.text || "";
            let collection = document.getElementById("collection").value;
            let model = document.getElementById("modelNumber").value;
            let ref = document.getElementById("watchRefNumber").value;

            let brandPart = brandText.replace(/\s+/g, "").substring(0, 4).toUpperCase();
            let collectionPart = collection.replace(/\s+/g, "").substring(0, 3).toUpperCase();
            let modelPart = model.replace(/\s+/g, "").substring(0, 3).toUpperCase();
            let refPart = ref.substring(ref.length - 4).toUpperCase();

            if (!brandPart) brandPart = "BRND";
            if (!collectionPart) collectionPart = "COL";
            if (!modelPart) modelPart = "MOD";
            if (!refPart) refPart = "0000";

            skuField.value = "JWS" + brandPart + collectionPart + refPart + modelPart;
        }

        function unlockAndRegenerate() {
            if (skuPopulating) return; // ✅ ignore triggers fired during edit population
            skuManuallySet = false;
            generateSKURealtime();
        }

        // ✅ If user manually types in SKU field directly → lock it
        document.getElementById("sku").addEventListener("input", function() {
            skuManuallySet = this.value.trim() !== '';
        });

        $('#brand').on('change.select2', unlockAndRegenerate);
        document.getElementById("collection").addEventListener("keyup", unlockAndRegenerate);
        document.getElementById("modelNumber").addEventListener("keyup", unlockAndRegenerate);
        document.getElementById("watchRefNumber").addEventListener("keyup", unlockAndRegenerate);
    </script>
    <script>
        function DuplicateModalSku() {

            let skuField = document.getElementById("skuModal");

            let brandText = document.getElementById("brandModal").selectedOptions[0]?.text || "";
            let collection = document.getElementById("collectionModal").value;
            let model = document.getElementById("pro_modelModal").value;
            let ref = document.getElementById("pro_ref_numModal").value;
            ...
            let finalSKU = "JWS" + brandPart + collectionPart + refPart + modelPart;

            skuField.value = finalSKU;
        }

        // ✅ Trigger Events (Modal Fields)
        $('#brandModal').on('change', function() {
            DuplicateModalSku();
        });

        document.getElementById("collectionModal").addEventListener("keyup", DuplicateModalSku);
        document.getElementById("pro_modelModal").addEventListener("keyup", DuplicateModalSku);
        document.getElementById("pro_ref_numModal").addEventListener("keyup", DuplicateModalSku);
    </script>
    ...
    `);
            ...
            let params = $.param({
                model_name: $('#filter_model_name').val(),
                model_number: $('#filter_model_number').val(),
                sku: $('#filter_sku').val(),
                business_location: $('#filter_business_location').val(),
                brand: $('#filter_brand').val(),
                stock: $('#filter_stock').val()
            });

            window.location.href = "{{ route('product.export') }}?" + params;
    ...
    <script>
        $(document).on('click', '#uploadBulkExcel', function() {

            let file = $('#bulk_excel_file')[0].files[0];
            ...
            $.ajax({
                url: "{{ route('product.bulk.update.excel') }}",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
            ...
            `;
                    ...
                    $('#bulkUpdateResult').html(html);
                },

                error: function() {

                    // enable again only if failed
                    $('#uploadBulkExcel')
                        .prop('disabled', false)
                        .html('Upload & Update');
        ...
        $('#bulkExcelModal').on('hidden.bs.modal', function() {
