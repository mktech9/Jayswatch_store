...
<body>
    ...
    <div class="page">
        ...
        <div class="page-header-breadcrumb d-md-flex d-block align-items-center justify-content-between ">
            <h4 class="fw-medium mb-0">Pending Product List</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0);" class="text-white-50">Pending Product List</a>
                </li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card custom-card">
                            ...
                            <div class="collapse show mb-3 d-none" id="filterCollapse">
                                <div class="p-3">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select id="filter_stock" class="form-select">
                                                ...
                                                <option value="notsell">Not For Selling</option>
                                            </select>
                                        </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="listUsers" role="tabpanel">
                                    <div class="table-responsive">
                                        <div class="d-flex justify-content-end mb-2 gap-2 d-none">
                                            <button class="btn btn-sm btn-outline-primary" id="scrollLeft">
                                                ◀
                                            </button>

                                            <button class="btn btn-sm btn-outline-primary" id="scrollRight">
                                                ▶
                                            </button>
                                        </div>

                                        <table class="table table-bordered text-nowrap w-100"
                                            id="pendingProductTable">
                                            <thead>
                                                <tr>
                                                    <th>No.</th>
                                                    <th>Action</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var pendingProductTable = $('#pendingProductTable').DataTable({
                processing: true,
                serverSide: true,
                scrollX: true,

                ajax: {
                    url: "{{ route('pendingpro.details') }}",
                    data: function(d) {
                ...
                //             <div>
                //                 <div>${data}</div>
                //                 <div style="color:red;font-size:12px;font-weight:600;">
                //                     (Out of Stock)
                //                 </div>
                //             </div>
                //         `;
                ...
                //             <div>
                //                 <div>${data}</div>
                //                 <div style="color:blue;font-size:12px;font-weight:600;">
                //                     (Not For Selling)
                //                 </div>
                //             </div>
                //         `;
                    ...
                    //         if (row.out_stock != 1 && row.not_for_selling != 1) {
                    //             alert();
                    //             return `
                //             <div>
                //                 <div>${data}</div>
                //                 <div style="color:green;font-size:12px;font-weight:600;">
                //                     (In Stock)
                //                 </div>
                //             </div>
                //         `;
        ...
        `;
            ...
            const autoEditId = params.get('edit_id');

            if (autoEditId) {

                // wait until datatable draws rows
                $('#pendingProductTable').on('draw.dt', function() {

                    let btn = $('.editPendingProduct[data-id="' + autoEditId + '"]');

                    if (btn.length) {

                        btn.trigger('click'); // 🔥 triggers your full edit logic

                        // run only once
                        $('#pendingProductTable').off('draw.dt');
 ...
 <div class="fw-medium">
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                $('#pendingProductTable').DataTable().ajax.reload();
                            }
                        });
                    }
                });
    ...
    <script>
        ...
        $('#brand').on('change.select2', function() {
            generateSKURealtime();
        });
        document.getElementById("collection").addEventListener("keyup", generateSKURealtime);
        document.getElementById("modelNumber").addEventListener("keyup", generateSKURealtime);
        document.getElementById("watchRefNumber").addEventListener("keyup", generateSKURealtime);
