...
<head>
    ...
    <meta name="title" content="Sell your watch | Jay's Watch Store Luxury Watch Seller" />
    <meta name="description"
        content="Sell your watch and get the best price of your timepiece. Get Competitive Quotes Within 24 Hours That Will Help You Get The Best Value For Your Watch." />
    <meta name="robots" content="INDEX,FOLLOW" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
    <meta name="format-detection" content="telephone=no" />
    <title>Sell your watch | Jay's Watch Store Luxury Watch Seller</title>
            ...
            <div class="columns">
                <div class="column main"><input name="form_key" type="hidden" value="i6mK3B87C46dukqj" />
                    ...
                    <div class="trade-cms">
                        ...
                        <section id="sll-wtch" class="nw-sll-wtch">
                            <div class="container">
                                <div class="sellWatchContent">
                                    ...
                                    <div class="sll-top">
                                        <h1 class="sec-ttl">Sell your watch</h1>
                                        <p>Jay's Watch Store has a team of watch specialists, who have the expertise and
                                            knowledge to get you the best value for your luxury watch</p>
                                    ...
                                    <div class="trade-up-stp container">
                                        <div class="stp-lst">
                                            ...
                                            <h4 class="stp-ttl">Tell us about your watch</h4>
                                            <p>Use our interactive online form to give us some information about the
                                                luxury timepiece you intend to sell, along with its few pictures and
                                                your personal information</p>
                                        </div>

                                        <div class="stp-lst">
                                            <span class="nw-spt-incs sell-wtch">2</span>
                                            <h4 class="stp-ttl">Approve the valuation</h4>
                                            <p>Based on the details you provide us, we’ll share a quotation within 24
                                                hours. If you’re happy with the quote, our watch consultant will reach
                                                out to have the watch collected for examination</p>
                                        </div>

                                        <div class="stp-lst">
                                            <span class="nw-spt-incs sell-wtch">3</span>
                                            <h4 class="stp-ttl">Quality check</h4>
                                            <p>Upon receiving the watch, our team of qualified watch experts will
                                                thoroughly inspect its condition and authenticity to finalise the
                                                purchase</p>
                                        </div>

                                        <div class="stp-lst">
                                            <span class="nw-spt-incs sell-wtch">4</span>
                                            <h4 class="stp-ttl">Receive payment</h4>
                                            <p>Once your watch passes our inspection process, you will receive the
                                                payment via a cheque or wire transfer.</p>
                                        </div>
                                    </div>
                                    <a class="kMore getQuote_btn ctClickNew" data-ct-event-name="Get A Quote"
                                        data-ct-attributes-value='{"Type":"Sell Page","Get A Quote Click": "Yes"}'
                                        onclick="dataLayer.push({'event':'link_click','page_type':'Sell Page','link_name':'Why sell your watch to - Get a Quote'});"
                                        href="#getQuote" title="Get a Quote"><span>get a quote</span><svg
                                            xmlns="http://www.w3.org/2000/svg" width="19.199" height="6.822"
                                            viewBox="0 0 19.199 6.822">
                                            <path id="np_arrow_2841243_000000"
                                                d="M30.574,39.316v2.677h-14.6v1.13h14.6v3.016l4.6-3.506Z"
                                                transform="translate(-15.973 -39.316)" fill-rule="evenodd"></path>
                                        </svg></a>
                        ...
                        <section id="why_buyFrom">
                            <div class="container">
                                <h2 class="sec-ttl">Why sell your watches to <span> Jay's Watch Store?</span></h2>
                                <hr />
                                <img src="{{ $actual_url . '/front/sell/why-sell-to-stz.jpg' }}" alt="Pre-owned Watches"
                                    width="685" style="width: 685px !important;" />
                                <p>Our credibility in the luxury watch segment makes the process of selling your watch
                                    extremely reliable. Our systematic processes and specialized team ensure privacy,
                                    authentication and genuine pricing for the seller. When a luxury watch is sold to
                                    Jay's watch Store, we help make the process as transparent as possible.</p>
                            </div>
                            <hr />
                            <div class="fcs-pnt container">
                                <div class="pnt-lst">
                                    <img src="{{ $actual_url . '/front/sell/i-privacy.svg' }}" alt="Privacy"
                                        width="26" style="width: 26px !important;">
                                    <div class="lst-cnt">
                                        <h4 class="pnt-ttl">Privacy</h4>
                                        <p>Be rest assured that your personal information and sale details will remain
                                            secure and private with us.</p>
                                    </div>
                                </div>
                                <div class="pnt-lst">
                                    <img src="{{ $actual_url . '/front/sell/i-choose-watch.svg' }}"
                                        alt="Genuine Price" width="22" style="width: 22px !important;">
                                    <div class="lst-cnt">
                                        <h4 class="pnt-ttl">Value for your watch</h4>
                                        <p>Our thorough and systematic processes, including the authentication and
                                            service of pre-owned watches, ensure that you get the best price for your
                                            watch.</p>
                                    </div>
                                </div>
                                <div class="pnt-lst">
                                    <img src="{{ $actual_url . '/front/sell/i-gen-price.svg' }}" alt="Easy Payment"
                                        width="27" style="width: 27px !important;">
                                    <div class="lst-cnt">
                                        <h4 class="pnt-ttl">Easy payment</h4>
                                        <p>Once the watch passes our authentication and inspection processes, and a
                                            final offer price is agreed upon, the transfer of payment to the seller is
                                            smooth and hassle-free.</p>
                                    </div>
                                </div>
                                <div class="pnt-lst">
                                    <img src="{{ $actual_url . '/front/sell/i-wrty.svg' }}" alt="Transparency"
                                        width="19" style="width: 19px !important;">
                                    <div class="lst-cnt">
                                        <h4 class="pnt-ttl">Transparency</h4>
                                        <p>Selling your watch is a simple procedure, however that doesn't mean you
                                            shouldn't know what's going on. We keep you updated throughout the procedure
                                            so you don't feel left out at any stage.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="sell-quote-wrap" id="getQuote" style="padding: 50px 0;">

                            <h2>Get your watch evaluated to receive a quote
                            </h2>


                            <div class="trade-quote-frm container" id="get-quote">

                                <div class="dflt-watch-wrp">
                                    <a id="product_url" href="javascript:void(0)">
                                        <img src="{{ $actual_url . '/front/trade/default-trade-watch.svg' }}"
                                            alt="Trade Watch" id="product_image"
                                ...
                                <form class="quote-frm stz-frm needs-validation" id="sellEnquiryForm" novalidate>
                                    ...
                                    <div class="wtch-info">
                                        ...
                                        <h4><span class="rnd-sp"><img
                                                    ...
                                                    alt="Size Chart" width="17" /></span>What are you selling?
                                        </h4>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="price" name="selling_price" class="form-select">
                                        ...
                                        <div class="upld-img">
                                            ...
                                            <input type="file"
                                                ...
                                                placeholder="upload image" onchange="fileNameShow();" />
                                    ...
                                    <div class="psnl-info other-info">
                                        <h4><span class="rnd-sp"><img
                                                    src="{{ $actual_url . '/front/trade/i-user.svg' }}"
                                                    alt="Size Chart" width="20" /></span>Personal Information</h4>
                                        <div class="mb-3">
                                            <label for="name">Name <span class="text-danger">*</span></label>
                                            <input type="text" name="name" id="trade-name"
                                                value="{{ $cust_data->full_name ?? '' }}" class="form-control"
                                                required />
                                            <div class="invalid-feedback text-right" style="font-size: 10px;">
                                                This Field is required.
                                            </div>
                                        ...
                                        <div class="field send-enter-otp-wrap">
                                            ...
                                            <div
                                                class="form-group  mt-10 field enter-otp-wrap enter-otp-wrap-register">
                                                ...
                                                <div class="otp-digit-btn-wrap">
                                                    <div class="otp-digit">
                                                        <input type="text" name="verify-otp-input1"
                                                            ...
                                                            id="verify-otp-input1" inputmode="numeric"
                                                            maxlength="1">
                                                        <input type="text" name="verify-otp-input2"
                                                            class="form-control verify-otp-input num-allowed"
                                                            id="verify-otp-input-2" inputmode="numeric"
                                                            maxlength="1">
                                                        <input type="text" name="verify-otp-input3"
                                                            class="form-control verify-otp-input num-allowed"
                                                            id="verify-otp-input-3" inputmode="numeric"
                                                            maxlength="1">
                                                        <input type="text" name="verify-otp-input4"
                                                            class="form-control verify-otp-input num-allowed"
                                                            id="verify-otp-input-4" inputmode="numeric"
                                                            maxlength="1">
                                                        <input type="text" name="verify-otp-input5"
                                                            class="form-control verify-otp-input num-allowed"
                                                            id="verify-otp-input-5" inputmode="numeric"
                                                            maxlength="1">
                                                        <input type="text" name="verify-otp-input6"
                                                            class="form-control verify-otp-input num-allowed"
                                                            id="verify-otp-input-6" inputmode="numeric"
                                                            maxlength="1">
                                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" name="email"
                                                value="{{ $cust_data->email ?? '' }}" id="trade-email"
                                                class="form-controlvalidate-email" required />
                                            <div class="invalid-feedback text-right" style="font-size: 10px;">
                                                This Field is required.
                                            </div>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.sendotp').click(function() {
                ...
                if (otpSending) return false; // prevent multiple clicks
                otpSending = true;
            ...
            // Form Submit
            $('#sellEnquiryForm').on('submit', function(e) {
