              ...
              <div class="wrap">
                              ...
                              <div>
                                  ...
                                  @if ($order)
                                      <div class="muted">We've sent a confirmation email to
                                          <strong>{{ $order->shipping_email }}</strong> with your order details.
                                      </div>
                                  @endif
                              </div>
                          </div>
                          ...
                          <div class="items">
                              @foreach ($orderItems as $item)
                                  @php
                                      ...
                                      $productSlug = \Illuminate\Support\Str::slug($item->product_name);
                  ...
                  @if ($order->payment_method == 'prebook')
                      <div id="prebook-terms" class="mt-2">
                          <div
                              style="
        border:2px solid #d7625f;
        background:#fbecec;
        padding:20px;
        border-radius:10px;
    ">
                              <h5 style="color:#b62522; font-weight:700; margin-bottom:15px;">
                                  Terms & Conditions for Advance Booking
                              </h5>

                              <div style="font-size:14px; line-height:1.6; color:#b62522;text-align: left;">

                                  <p style="margin-bottom:8px;">
                                      <span style="color:#b62522; font-weight:bold;">•</span>
                  ...
                  <div class="actions">
                      ...
                      @if (empty($order->tracking_num))
                          <a class="btn btn-primary d-none" target="_blank"
                              href="{{ route('invoice.print', ['order_id' => $order->order_id]) }}" disabled>
                              Download Invoice
                          </a>
                      @endif
